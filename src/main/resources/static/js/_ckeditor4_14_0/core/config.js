...
CKEDITOR.config = {
	 ...
	 * @cfg {String/String[]}
	 */
	removePlugins: 'elementspath,save,font,smiley,templates,print,iframe,newpage,forms,showblocks,pagebreak,div,about,bidi,language,removeformat,stylescombo,colorbutton,selectall,blockquote,copyformatting',
