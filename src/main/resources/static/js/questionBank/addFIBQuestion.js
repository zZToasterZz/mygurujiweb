...
function newQuestionBlock(){
	var newBlockHtml = ''
						+ '<div class="questionBlock w3-panel w3-animate-top my-border"><div class="w3-black" style="margin-top: 16px;">'
						+ '<h4 style="padding-top:8px; padding-left:8px">Add Question <i>(Fill in the Blank Type)</i></h4>'
