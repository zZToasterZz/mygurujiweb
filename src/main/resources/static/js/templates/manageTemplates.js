$(function() {
	$("#searchTemplates").click(function(){
		...
		var jsonUrl = '/managetemplates/gettemplatebyemplid/' + emplid;
		
		if($.fn.DataTable.isDataTable('#assessmentList')){
			$("#assessmentList").DataTable().destroy();searchTemplates
		}
...
$('#displayAddTemplateForm').on('click', function(){
